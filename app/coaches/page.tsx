...
const coachTranslations: Record<string, Record<string, {
  ...
  "volha-yefimenka": {
    pl: {
      specialty: "Karate (dzieci 1-й и 2-й rok), trening motoryczny VolatMOVE Junior, Muay Thai",
      experience: "12+ lat doświadczenia",
    ...
    uk: {
      specialty: "Карате (діти 1-й та 2-й рік), моторичний тренінг VolatMOVE Junior, Муай Тай",
    ...
    en: {
      specialty: "Karate (children 1st and 2nd year), VolatMOVE Junior motor training, Muay Thai",
    ...
    by: {
      specialty: "Каратэ (дзеці 1-й і 2-й год), маторныя трэніроўкі VolatMOVE Junior, Муай Тай",
  ...
  "pawel-szymkowicz": {
    ...
    en: {
      specialty: "MMA coach for children from 6 years, youth and adults",
  ...
  "daria-koba": {
    ...
    en: {
      specialty: "VolatMOVE Kids motor training (children 4-7 years), Judo for children",
                    ...
                    <CardContent className="px-6 pb-6 flex-1 flex flex-col">
                      ...
                      <div className="grid grid-cols-1 gap-3 mb-4">
                        <div className="bg-gray-800/50 rounded-lg p-2">
                          ...
                          <div className="text-white text-xs font-primary">{coachT.students}</div>
                        </div>
                      </div>
