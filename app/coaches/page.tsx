...
// Helper function to get translated coach data
const getCoachData = (coachId: string, lang: string) => {
  const coachTranslations: Record<string, Record<string, Record<string, string>>> = {
    "vital-rak": {
      pl: {
      ...
      uk: {
        specialty: "Головний тренер, карате (спортивна група, дорослі), функціональний тренінг",
      ...
      en: {
        specialty: "Head coach, karate (sports group, adults), functional training",
        experience: "15+ years of experience",
        description: "Head coach of VOLAT club with years of experience in karate and functional training. Master of Sports, certified WKF instructor. Specializes in preparing athletes for international competitions. Conducts sports karate group and classes for adults as well as functional training.",
        students: "180+ students"
      },
      by: {
        specialty: "Галоўны трэнер, каратэ (спартыўная група, дарослыя), функцыянальныя трэніроўкі",
    ...
    "volha-yefimenka": {
      pl: {
        specialty: "Karate (dzieci 1-й и 2-й rok nauki), trening motoryczny VolatMOVE Junior, Muay Thai",
      ...
      uk: {
        specialty: "Карате (діти 1-й та 2-й рік навчання), моторичний тренінг VolatMOVE Junior, Муай Тай",
      ...
      en: {
        specialty: "Karate (children 1st and 2nd year of training), motor training VolatMOVE Junior, Muay Thai",
        experience: "12+ years of experience",
        description: "Specialist in children's karate and motor training. Conducts karate classes for children aged 7-11 (1st and 2nd year of training), VolatMOVE Junior motor training, and Muay Thai classes. Has a unique approach to the youngest athletes. Certified instructor with years of experience working with children.",
        students: "160+ students"
      },
      by: {
        specialty: "Каратэ (дзеці 1-й і 2-й год навучання), маторныя трэніроўкі VolatMOVE Junior, Муай Тай",
        experience: "12+ гадоў вопыту",
        description: "Спецыялістка па каратэ для дзяцей і маторных трэніроўках. Праводзіць заняткі каратэ для дзяцей ва ўзросце 7-11 гадоў (1-й і 2-й год навучання), маторныя трэніроўкі VolatMOVE Junior і заняткі Муай Тай. Мае ўнікальны падыход да самых маладых спартсменаў. Сертыфікаваная інструктарка з шматгадовым вопытам працы з дзецьмі.",
        students: "160+ вучняў"
      }
    },
    "mikola-taczylin": {
      ...
      uk: {
        ...
        description: "Експерт з Муай Тай з багаторічним професійним досвідом. Колишній спортсмен, зараз тренер, який готує спортсменів до боїв і змагань найвищого рівня. Спеціалізується на тренуванні всіх вікових груп.",
        students: "180+ спортсменів"
      },
      en: {
        specialty: "Muay Thai coach for children, youth and adults",
        experience: "18+ years of experience",
        description: "Expert in Muay Thai with years of professional experience. Former athlete, now a coach preparing athletes for fights and competitions at the highest level. Specializes in training all age groups.",
        students: "180+ athletes"
      },
      by: {
        specialty: "Трэнер Муай Тай для дзяцей, моладзі і дарослых",
        experience: "18+ гадоў вопыту",
        description: "Эксперт па Муай Тай з шматгадовым прафесійным вопытам. Былы спартсмен, цяпер трэнер, які рыхтуе спартсменаў да боек і спаборніцтваў найвышэйшага ўзроўню. Спецыялізуецца на трэніроўцы ўсіх узроставых груп.",
    ...
    "pawel-szymkowicz": {
      ...
      uk: {
        ...
        description: "Спеціаліст з ММА з багаторічним досвідом тренування спортсменів усіх вікових груп. Сертифікований інструктор з міжнародними досягненнями. Спеціалізується на техніках змішаних бойових мистецтв.",
      ...
      by: {
        ...
        description: "Спецыяліст па ММА з шматгадовым вопытам трэніроўкі спартсменаў усіх узроставых груп. Сертыфікаваны інструктар з міжнароднымі дасягненнямі. Спецыялізуецца на тэхніках змешаных баявых мастацтваў.",
    ...
    "daria-koba": {
      ...
      uk: {
        specialty: "Моторичний тренінг VolatMOVE Kids (діти 4-7 років), Дзюдо для дітей",
        experience: "8+ років досвіду",
        description: "Спеціалістка з моторичного тренінгу для наймолодших дітей та дзюдо. Має унікальний підхід до роботи з дітьми дошкільного та шкільного віку. Сертифікована інструкторка з багаторічним досвідом розвитку основних моторичних навичок та тренінгу дзюдо для дітей.",
        students: "120+ дітей"
      },
      en: {
        specialty: "Motor training VolatMOVE Kids (children 4-7 years), Judo for children",
        experience: "8+ years of experience",
        description: "Specialist in motor training for the youngest children and judo. Has a unique approach to working with preschool and school-age children. Certified instructor with years of experience in developing basic motor skills and judo training for children.",
        students: "120+ children"
      },
      by: {
        specialty: "Маторныя трэніроўкі VolatMOVE Kids (дзеці 4-7 гадоў), Дзюдо для дзяцей",
        experience: "8+ гадоў вопыту",
        description: "Спецыялістка па маторных трэніроўках для самых маладых дзяцей і дзюдо. Мае ўнікальны падыход да працы з дзецьмі дашкольнага і школьнага ўзросту. Сертыфікаваная інструктарка з шматгадовым вопытам развіцця асноўных маторных навыкаў і трэніроўкі дзюдо для дзяцей.",
        students: "120+ дзяцей"
      }
    }
  }

  const achievementsTranslations: Record<string, Record<string, string[]>> = {
    "vital-rak": {
      pl: ["Mistrz Sportu w Karate", "Certyfikat WKF 3 Dan", "Trener Kadry Narodowej", "Instruktor Treningu Funkcjonalnego", "Specjalista Rehabilitacji Sportowej"],
      uk: ["Майстер спорту з карате", "Сертифікат WKF 3 Дан", "Тренер національної збірної", "Інструктор функціонального тренінгу", "Спеціаліст спортивної реабілітації"],
      en: ["Karate Master of Sports", "WKF 3 Dan Certificate", "National Team Coach", "Functional Training Instructor", "Sports Rehabilitation Specialist"],
      by: ["Майстар спорту па каратэ", "Сертыфікат WKF 3 Дан", "Трэнер нацыянальнай зборнай", "Інструктар функцыянальных трэніровак", "Спецыяліст спартыўнай рэабілітацыі"]
    },
    "volha-yefimenka": {
      pl: ["Mistrzyni Białorusi w Karate", "Certyfikat Instruktora Dziecięcego", "Specjalistka Treningu Motorycznego", "Trener Grup Dziecięcych", "Instruktor VolatMOVE Junior", "Ekspert Rozwoju Koordynacji"],
      uk: ["Майстриня Білорусі з карате", "Сертифікат дитячого інструктора", "Спеціалістка моторичного тренінгу", "Тренер дитячих груп", "Інструктор VolatMOVE Junior", "Експерт розвитку координації"],
      en: ["Belarus Karate Champion", "Children's Instructor Certificate", "Motor Training Specialist", "Children's Group Coach", "VolatMOVE Junior Instructor", "Coordination Development Expert"],
      by: ["Майстрыня Беларусі па каратэ", "Сертыфікат дзіцячага інструктара", "Спецыялістка маторных трэніровак", "Трэнер дзіцячых груп", "Інструктар VolatMOVE Junior", "Эксперт развіцця каардынацыі"]
    },
    "mikola-taczylin": {
      pl: ["Były Zawodnik Muay Thai", "Mistrz Europy Kickboxingu", "Certyfikat IFMA", "Trener Grup Dziecięcych", "Specjalista Techniki Uderzeń"],
      uk: ["Колишній спортсмен Муай Тай", "Чемпіон Європи з кікбоксингу", "Сертифікат IFMA", "Тренер дитячих груп", "Спеціаліст техніки ударів"],
      en: ["Former Muay Thai Athlete", "European Kickboxing Champion", "IFMA Certificate", "Children's Group Coach", "Strike Technique Specialist"],
      by: ["Былы спартсмен Муай Тай", "Чэмпіён Еўропы па кікбоксінгу", "Сертыфікат IFMA", "Трэнер дзіцячых груп", "Спецыяліст тэхнікі удараў"]
    },
    "wiktor-muronczyk": {
      pl: ["Międzynarodowy Mistrz Szachowy", "Trener FIDE", "Sędzia Turniejów Szachowych", "Autor Programów Edukacyjnych", "Specjalista Psychologii Sportu"],
      uk: ["Міжнародний шаховий майстер", "Тренер FIDE", "Суддя шахових турнірів", "Автор освітніх програм", "Спеціаліст спортивної психології"],
      en: ["International Chess Master", "FIDE Trainer", "Chess Tournament Judge", "Educational Program Author", "Sports Psychology Specialist"],
      by: ["Міжнародны шахматны майстар", "Трэнер FIDE", "Суддзя шахматных турніраў", "Аўтар адукацыйных праграм", "Спецыяліст спартыўнай псіхалогіі"]
    },
    "pawel-szymkowicz": {
      pl: ["Mistrz Polski w MMA", "Certyfikat Instruktora MMA", "Trener Grup Dziecięcych", "Specjalista Technik Mieszanych", "Ekspert Walki w Parterze"],
      uk: ["Чемпіон Польщі з ММА", "Сертифікат інструктора ММА", "Тренер дитячих груп", "Спеціаліст змішаних технік", "Експерт боротьби в партері"],
      en: ["Polish MMA Champion", "MMA Instructor Certificate", "Children's Group Coach", "Mixed Techniques Specialist", "Ground Fighting Expert"],
      by: ["Чэмпіён Польшчы па ММА", "Сертыфікат інструктара ММА", "Трэнер дзіцячых груп", "Спецыяліст змешаных тэхнік", "Эксперт барацьбы ў партэры"]
    },
    "daria-koba": {
      pl: ["Certyfikat Instruktora Treningu Motorycznego", "Certyfikat Instruktora Judo", "Specjalistka Pracy z Dziećmi", "Trener Grup Dziecięcych", "Ekspert Rozwoju Koordynacji", "Instruktor VolatMOVE Kids"],
      uk: ["Сертифікат інструктора моторичного тренінгу", "Сертифікат інструктора дзюдо", "Спеціалістка роботи з дітьми", "Тренер дитячих груп", "Експерт розвитку координації", "Інструктор VolatMOVE Kids"],
      en: ["Motor Training Instructor Certificate", "Judo Instructor Certificate", "Children's Work Specialist", "Children's Group Coach", "Coordination Development Expert", "VolatMOVE Kids Instructor"],
      by: ["Сертыфікат інструктара маторных трэніровак", "Сертыфікат інструктара дзюдо", "Спецыялістка працы з дзецьмі", "Трэнер дзіцячых груп", "Эксперт развіцця каардынацыі", "Інструктар VolatMOVE Kids"]
    }
  }

  const specialtiesTranslations: Record<string, Record<string, string[]>> = {
    "vital-rak": {
      pl: ["Karate WKF (sportowa grupa)", "Trening Funkcjonalny", "Przygotowanie Fizyczne", "Przygotowanie do Zawodów"],
      uk: ["Карате WKF (спортивна група)", "Функціональний тренінг", "Фізична підготовка", "Підготовка до змагань"],
      en: ["Karate WKF (sports group)", "Functional Training", "Physical Preparation", "Competition Preparation"],
      by: ["Каратэ WKF (спартыўная група)", "Функцыянальныя трэніроўкі", "Фізічная падрыхтоўка", "Падрыхтоўка да спаборніцтваў"]
    },
    "volha-yefimenka": {
      pl: ["Karate (dzieci 1-2 rok)", "Trening Motoryczny VolatMOVE Junior", "Muay Thai", "Rozwój Koordynacji"],
      uk: ["Карате (діти 1-2 рік)", "Моторичний тренінг VolatMOVE Junior", "Муай Тай", "Розвиток координації"],
      en: ["Karate (children 1-2 year)", "VolatMOVE Junior Motor Training", "Muay Thai", "Coordination Development"],
      by: ["Каратэ (дзеці 1-2 год)", "Маторныя трэніроўкі VolatMOVE Junior", "Муай Тай", "Развіццё каардынацыі"]
    },
    "mikola-taczylin": {
      pl: ["Muay Thai", "Boks", "Kickboxing", "Trening Dziecięcy"],
      uk: ["Муай Тай", "Бокс", "Кікбоксинг", "Дитячий тренінг"],
      en: ["Muay Thai", "Boxing", "Kickboxing", "Children's Training"],
      by: ["Муай Тай", "Бокс", "Кікбоксінг", "Дзіцячыя трэніроўкі"]
    },
    "wiktor-muronczyk": {
      pl: ["Szachy", "Strategia", "Logika", "Rozwój Intelektualny"],
      uk: ["Шахи", "Стратегія", "Логіка", "Інтелектуальний розвиток"],
      en: ["Chess", "Strategy", "Logic", "Intellectual Development"],
      by: ["Шахматы", "Стратэгія", "Логіка", "Інтэлектуальнае развіццё"]
    },
    "pawel-szymkowicz": {
      pl: ["MMA", "Walka w Parterze", "Techniki Mieszane", "Walka w Klinczu"],
      uk: ["ММА", "Боротьба в партері", "Змішані техніки", "Боротьба в клінчі"],
      en: ["MMA", "Ground Fighting", "Mixed Techniques", "Clinch Fighting"],
      by: ["ММА", "Барацьба ў партэры", "Змешаныя тэхнікі", "Барацьба ў клінчы"]
    },
    "daria-koba": {
      pl: ["Judo (dzieci)", "Trening Motoryczny", "VolatMOVE Kids", "Rozwój Koordynacji"],
      uk: ["Дзюдо (діти)", "Моторичний тренінг", "VolatMOVE Kids", "Розвиток координації"],
      en: ["Judo (children)", "Motor Training", "VolatMOVE Kids", "Coordination Development"],
      by: ["Дзюдо (дзеці)", "Маторныя трэніроўкі", "VolatMOVE Kids", "Развіццё каардынацыі"]
    }
  }

  return {
    specialty: coachTranslations[coachId]?.[lang]?.specialty || "",
    experience: coachTranslations[coachId]?.[lang]?.experience || "",
    description: coachTranslations[coachId]?.[lang]?.description || "",
    students: coachTranslations[coachId]?.[lang]?.students || "",
    achievements: achievementsTranslations[coachId]?.[lang] || [],
    specialties: specialtiesTranslations[coachId]?.[lang] || []
  }
}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {coaches.map((coach, index) => {
              const coachData = getCoachData(coach.id, currentLang)
              return (
                ...
                <Card className="border-2 border-red-400/30 shadow-2xl rounded-3xl bg-gradient-to-br from-gray-900 to-black hover:shadow-red-400/20 hover:shadow-3xl transition-all duration-300 group overflow-hidden backdrop-blur-md flex-1 flex flex-col min-h-[600px]">
                  <Link href={`/coaches/${coach.id}`} className="flex-1 flex flex-col">
                    ...
                    <CardHeader className="p-6">
                      <CardTitle className="font-display text-xl text-white mb-3 font-bold bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent break-words">{coach.name}</CardTitle>
                      <CardDescription className="font-primary">
                        <Badge
                          variant="secondary"
                          className="mb-3 bg-gradient-to-r from-red-500 to-red-600 text-white px-3 py-1 text-xs shadow-md font-accent font-bold break-words"
                        >
                          {coachData.specialty || coach.specialty}
                        </Badge>
                        <p className="text-gray-300 text-sm font-primary font-light mb-2 break-words">{coachData.experience || coach.experience}</p>
                        <div className="flex items-center gap-2 text-gray-400 text-xs mb-2">
                          <Users className="w-3 h-3 flex-shrink-0" />
                          <span className="font-primary break-words">{coachData.students || coach.students}</span>
                        </div>
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="px-6 pb-6 flex-1 flex flex-col">
                      <p className="text-gray-400 text-sm leading-relaxed font-primary font-light mb-4 flex-1 break-words">
                        {coachData.description || coach.description}
                      </p>
                      ...
                      <div className="grid grid-cols-1 gap-3 mb-4">
                        <div className="bg-gray-800/50 rounded-lg p-2">
                          ...
                          <div className="text-white text-xs font-primary break-words">{coachData.students || coach.students}</div>
                        </div>
                      </div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(coachData.specialties.length > 0 ? coachData.specialties : coach.specialties).slice(0, 3).map((specialty, i) => (
                            <Badge key={i} variant="outline" className="border-red-500/30 text-red-300 text-xs font-primary bg-red-500/10 break-words">
                              {specialty}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="text-gray-400 text-xs space-y-1">
                          {(coachData.achievements.length > 0 ? coachData.achievements : coach.achievements).slice(0, 3).map((achievement, i) => (
                            <li key={i} className="flex items-start gap-2 font-primary">
                              <div className="w-1 h-1 bg-gradient-to-r from-red-500 to-red-400 rounded-full flex-shrink-0 mt-1.5"></div>
