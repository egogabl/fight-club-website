                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {groupedSchedule[day].map((item, index) => {
                      const getDisciplineKey = (discipline: string) => {
                        ...
                        if (discipline.includes("2. rok") || discipline.includes("2-й rok") || discipline.includes("2-й год")) return "karate-year-2"
                        if (discipline.includes("1. rok") || discipline.includes("1-й rok") || discipline.includes("1-й год")) return "karate-year-1"
